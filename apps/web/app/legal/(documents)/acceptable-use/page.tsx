...
const description =
  'This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by Eververse under any ongoing agreement.';
...
const Privacy = () => (
  <>
    ...
    <p>
      Eververse customers found engaging in activities prohibited by this
    ...
    <p>
      ...
      but isn’t limited to subscribing email addresses or telephone numbers to
      any messaging list without the permission of the email address or
      telephone number owner, and storing any email addresses or telephone
      numbers subscribed in this way. All messaging lists run on or hosted by
      our Products must be “confirmed opt-in”. Verification of the address or
    ...
    <h3>Unauthorized use of Eververse property</h3>
    <p>
      We prohibit the impersonation of Eververse, the representation of a
      significant business relationship with Eververse, or ownership of any
      Eververse property (including our Products and brand) for the purpose of
