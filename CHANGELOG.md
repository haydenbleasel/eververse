# v1.6.10 (Fri Feb 13 2026)

#### ⚠️ Pushed to `main`

- Fix versions ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix DB Url ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Next CVE [#40](https://github.com/haydenbleasel/eververse/pull/40) ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.5.7 (Tue May 27 2025)

#### ⚠️ Pushed to `main`

- Update avatar.tsx ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Make intercom webhook more reliable ([@haydenbleasel](https://github.com/haydenbleasel))
...
- More fixes ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix identify hook ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.2.4 (Thu May 22 2025)

#### ⚠️ Pushed to `main`

- Fix pageview lib ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Attempt to fix Prisma issue ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Temporarily disable openapi script ([@haydenbleasel](https://github.com/haydenbleasel))
- Update package.json ([@haydenbleasel](https://github.com/haydenbleasel))
